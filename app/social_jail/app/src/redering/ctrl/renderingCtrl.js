var renderCtrl = function ($scope, $element, renderModelFactory) {
    ...
    var init = function () {
        ...
        renderModel.renderer.shadowMapBias = 0.002;
        renderModel.renderer.shadowMapDarkness = 1;
...
angular.module('app.rendering').controller('RenderingController', ['$scope', '$element', 'renderModelFactory', renderCtrl]);